...
const Hero = () => {
  return (
    ...
    ${styles.paddingY}`}>
      <div className ={`flex-1 ${styles.flexStart} xl:px-0 sm:px-16 px-6 flex-col`}>
        <div className ={`flex flex-row items-start
            py-2 px-4 bg-discount-gradient rounded-[0.62rem] mb-2`}>
        ...
        <div className="flex flex-row justify-between
          items-center w-full">
            <h1 className=" flex-1 font-semibold font-poppins ss:text-[72px]
        ...
        <h1 className="font-semibold font-poppins ss:text-[68px]
